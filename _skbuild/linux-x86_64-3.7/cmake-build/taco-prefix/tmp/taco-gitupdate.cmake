...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/sayandip/sparse/_skbuild/linux-x86_64-3.7/cmake-build/taco-prefix/src/taco'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/sayandip/sparse/_skbuild/linux-x86_64-3.7/cmake-build/taco-prefix/src/taco'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
